...
{	
	...
	public sealed class TimeBlockTest : TestUnitBase
	{
		...
		public void MomentTest()
		{
			...
			Assert.Equal<DateTime>( timeBlock.Start, moment );
			Assert.Equal<DateTime>( timeBlock.End, moment );
		...
		public void NonMomentTest()
		{
			...
			Assert.False( timeBlock.IsMoment );
			Assert.Equal<TimeSpan>( timeBlock.Duration, delta );
		} // NonMomentTest
		...
		public void StartTest()
		{
			...
			Assert.Equal<DateTime>( timeBlock.Start, changedStart );
			Assert.Equal<TimeSpan>( timeBlock.Duration, duration );
		} // StartTest
		...
		public void EndTest()
		{
			...
			Assert.Equal<DateTime>( timeBlock.End, changedEnd );
			Assert.Equal<TimeSpan>( timeBlock.Duration, duration );
		} // EndTest
		...
		public void DurationTest()
		{
			...
			Assert.Equal<DateTime>( timeBlock.Start, start );
			Assert.Equal<DateTime>( timeBlock.End, end.Add( delta ) );
			Assert.Equal<TimeSpan>( timeBlock.Duration, newDuration );
		...
		public void DurationFromEndTest()
		{
			...
			Assert.Equal<DateTime>( timeBlock.Start, start.Subtract( delta ) );
			Assert.Equal<DateTime>( timeBlock.End, end );
			Assert.Equal<TimeSpan>( timeBlock.Duration, newDuration );
		...
		public void GetPreviousPeriodTest()
		{
			...
			Assert.Equal<DateTime>( previousTimeBlock.Start, start.Subtract( duration ) );
			Assert.Equal<DateTime>( previousTimeBlock.End, start );
			Assert.Equal<TimeSpan>( previousTimeBlock.Duration, duration );
			...
			Assert.Equal<DateTime>( previousOffsetTimeBlock.Start, start.Subtract( duration ).Add( previousOffset )  );
			Assert.Equal<DateTime>( previousOffsetTimeBlock.End, end.Subtract( duration ) .Add( previousOffset )  );
			Assert.Equal<TimeSpan>( previousOffsetTimeBlock.Duration, duration );
		...
		public void GetNextPeriodTest()
		{
			...
			Assert.Equal<DateTime>( nextTimeBlock.Start, end );
			Assert.Equal<DateTime>( nextTimeBlock.End, end.Add( duration ) );
			Assert.Equal<TimeSpan>( nextTimeBlock.Duration, duration );

			TimeSpan nextOffset = Duration.Hour;
			ITimeBlock nextOffsetTimeBlock = timeBlock.GetNextPeriod( nextOffset );
			Assert.Equal<DateTime>( nextOffsetTimeBlock.Start, end.Add( nextOffset ) );
			Assert.Equal<DateTime>( nextOffsetTimeBlock.End, end.Add( duration + nextOffset ) );
			Assert.Equal<TimeSpan>( nextOffsetTimeBlock.Duration, duration );
		} // GetNextPeriodTest
