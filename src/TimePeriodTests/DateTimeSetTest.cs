...
namespace TimePeriod.Tests
{
	...
	public sealed class DateTimeSetTest : TestUnitBase
	{
		...
		public void ItemTest()
		{
			...
			Assert.Equal<DateTime>( dateTimeSet[ 0 ], previousCalendarYear );
			Assert.Equal<DateTime>( dateTimeSet[ 1 ], currentCalendarYear );
			Assert.Equal<DateTime>( dateTimeSet[ 2 ], nextCalendarYear );
		} // ItemTest
		...
		public void IndexOfTest()
		{
			...
			Assert.Equal<int>( dateTimeSet.IndexOf( currentCalendarYear ), -1 );
			Assert.Equal<int>( dateTimeSet.IndexOf( previousCalendarYear ), -1 );
			Assert.Equal<int>( dateTimeSet.IndexOf( nextCalendarYear ), -1 );
		...
		public void FindPreviousTest()
		{
			...
			dateTimeSet.Add( currentCalendarYear );
			Assert.Equal<DateTime?>( dateTimeSet.FindPrevious( now ), now == currentCalendarYear ? (DateTime?)null : currentCalendarYear );
