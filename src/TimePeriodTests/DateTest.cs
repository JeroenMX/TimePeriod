...
namespace TimePeriod.Tests
{
	...
	public sealed class DateTest : TestUnitBase
	{
		...
		public void DefaultConstructorTest()
		{
			...
			Assert.Equal<int>( date.Year, year );
			Assert.Equal(1, date.Month);
			Assert.Equal(1, date.Day);
		...
		public void DateTimeConstructorTest()
		{
			...
			Assert.Equal<int>( date.Year, dateTime.Year );
			Assert.Equal<int>( date.Month, dateTime.Month );
			Assert.Equal<int>( date.Day, dateTime.Day );
		...
		public void DateTimeTest1()
		{
			...
			Assert.Equal<DateTime>( date1.DateTime, dateTime1.Date );

			DateTime dateTime2 = new DateTime( 2009, 7, 22, 18, 23, 56, 344 );
			Date date2 = new Date( dateTime2 );
			Assert.Equal<DateTime>( date2.DateTime, dateTime2.Date );
		} // DateTimeTest1
		...
		public void ToDateTimeTest2()
		{
			...
			Assert.Equal<DateTime>( date.DateTime, dateTime );
			Assert.Equal<DateTime>( date.ToDateTime( 1 ), new DateTime( dateTime.Year, dateTime.Month, dateTime.Day, 1, 0, 0, 0 ) );
			Assert.Equal<DateTime>( date.ToDateTime( 1, 1 ), new DateTime( dateTime.Year, dateTime.Month, dateTime.Day, 1, 1, 0, 0 ) );
			Assert.Equal<DateTime>( date.ToDateTime( 1, 1, 1 ), new DateTime( dateTime.Year, dateTime.Month, dateTime.Day, 1, 1, 1, 0 ) );
			Assert.Equal<DateTime>( date.ToDateTime( 1, 1, 1, 1 ), new DateTime( dateTime.Year, dateTime.Month, dateTime.Day, 1, 1, 1, 1 ) );
		} // ToDateTimeTest2
		...
		public void GetDateTimeFromTimeTest()
		{
			...
			Assert.Equal<DateTime>( date.ToDateTime( time ), dateTime.Add( timeSpan ) );
