...
{		
	public sealed class TestDataTest : TestUnitBase
	{
		...
		public void SchoolDayLessonsTest()
		{
			...
			Assert.Equal<DateTime>( lesson4.End,
		...
		public void SchoolDayTest()
		{
			...
			Assert.Equal<TimeSpan>( schoolDay.Lesson1.Duration, Lesson.LessonDuration );
			Assert.Equal<DateTime>( schoolDay.Lesson1.Start, start );

			Assert.Equal<TimeSpan>( schoolDay.Break1.Duration, ShortBreak.ShortBreakDuration );
			Assert.Equal( schoolDay.Break1.Start, schoolDay.Lesson1.End );

			Assert.Equal<TimeSpan>( schoolDay.Lesson2.Duration, Lesson.LessonDuration );
			Assert.Equal( schoolDay.Lesson2.Start, schoolDay.Break1.End );

			Assert.Equal<TimeSpan>( schoolDay.Break2.Duration, LargeBreak.LargeBreakDuration );
			Assert.Equal( schoolDay.Break2.Start, schoolDay.Lesson2.End );

			Assert.Equal<TimeSpan>( schoolDay.Lesson3.Duration, Lesson.LessonDuration );
			Assert.Equal( schoolDay.Lesson3.Start, schoolDay.Break2.End );

			Assert.Equal<TimeSpan>( schoolDay.Break3.Duration, ShortBreak.ShortBreakDuration );
			Assert.Equal( schoolDay.Break3.Start, schoolDay.Lesson3.End );

			Assert.Equal<TimeSpan>( schoolDay.Lesson4.Duration, Lesson.LessonDuration );
