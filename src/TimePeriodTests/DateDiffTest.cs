...
namespace TimePeriod.Tests
{
	...
	public sealed class DateDiffTest : TestUnitBase
	{
		...
		public void EmptyDateDiffTest()
		{
			...
			Assert.Equal<TimeSpan>( dateDiff.Difference, TimeSpan.Zero );
		...
		public void YearsTest()
		{
			...
			Assert.Equal<int>( dateDiff12.Hours, 365 * TimeSpec.HoursPerDay );
			Assert.Equal<int>( dateDiff12.Minutes, 365 * TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour );
			Assert.Equal<int>( dateDiff12.Seconds, 365 * TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour * TimeSpec.SecondsPerMinute );

			DateDiff dateDiff13 = new DateDiff( date1, date3 );
			Assert.Equal<int>( dateDiff13.ElapsedYears, -1 );
			...
			Assert.Equal<int>( dateDiff13.Years, -1 );
			Assert.Equal<int>( dateDiff13.Quarters, TimeSpec.QuartersPerYear * -1 );
			Assert.Equal<int>( dateDiff13.Months, TimeSpec.MonthsPerYear * -1 );
			Assert.Equal<int>( dateDiff13.Weeks, -52 );
			Assert.Equal<int>( dateDiff13.Days, -366 );
			Assert.Equal<int>( dateDiff13.Hours, 366 * TimeSpec.HoursPerDay * -1 );
			Assert.Equal<int>( dateDiff13.Minutes, 366 * TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour * -1 );
			Assert.Equal<int>( dateDiff13.Seconds, 366 * TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour * TimeSpec.SecondsPerMinute * -1 );
		} // YearsTest
		...
		public void QuartersTest()
		{
			...
			Assert.Equal<int>( dateDiff12.Hours, 92 * TimeSpec.HoursPerDay );
			Assert.Equal<int>( dateDiff12.Minutes, 92 * TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour );
			Assert.Equal<int>( dateDiff12.Seconds, 92 * TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour * TimeSpec.SecondsPerMinute );

			DateDiff dateDiff13 = new DateDiff( date1, date3 );
			Assert.Equal(0, dateDiff13.ElapsedYears);
			Assert.Equal<int>( dateDiff13.ElapsedMonths, -3 );
			Assert.Equal(0, dateDiff13.ElapsedDays);
			Assert.Equal(0, dateDiff13.ElapsedHours);
			Assert.Equal(0, dateDiff13.ElapsedMinutes);
			Assert.Equal(0, dateDiff13.ElapsedSeconds);
			...
			Assert.Equal<int>( dateDiff13.Quarters, -1 );
			Assert.Equal( dateDiff13.Months, -TimeSpec.MonthsPerQuarter );
			Assert.Equal<int>( dateDiff13.Weeks, -13 );
			Assert.Equal<int>( dateDiff13.Days, -90 );
			Assert.Equal<int>( dateDiff13.Hours, 90 * TimeSpec.HoursPerDay * -1 );
			Assert.Equal<int>( dateDiff13.Minutes, 90 * TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour * -1 );
			Assert.Equal<int>( dateDiff13.Seconds, 90 * TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour * TimeSpec.SecondsPerMinute * -1 );
		} // YearsTest
		...
		public void MonthsTest()
		{
			...
			Assert.Equal<int>( dateDiff12.Hours, 31 * TimeSpec.HoursPerDay );
			Assert.Equal<int>( dateDiff12.Minutes, 31 * TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour );
			Assert.Equal<int>( dateDiff12.Seconds, 31 * TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour * TimeSpec.SecondsPerMinute );

			DateDiff dateDiff13 = new DateDiff( date1, date3 );
			Assert.Equal(0, dateDiff13.ElapsedYears);
			Assert.Equal<int>( dateDiff13.ElapsedMonths, -1 );
			Assert.Equal(0, dateDiff13.ElapsedDays);
			Assert.Equal(0, dateDiff13.ElapsedHours);
			Assert.Equal(0, dateDiff13.ElapsedMinutes);
			Assert.Equal(0, dateDiff13.ElapsedSeconds);
			...
			Assert.Equal<int>( dateDiff13.Months, -1 );
			Assert.Equal<int>( dateDiff13.Weeks, -4 );
			Assert.Equal<int>( dateDiff13.Days, 30 * -1 );
			Assert.Equal<int>( dateDiff13.Hours, 30 * TimeSpec.HoursPerDay * -1 );
			Assert.Equal<int>( dateDiff13.Minutes, 30 * TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour * -1 );
			Assert.Equal<int>( dateDiff13.Seconds, 30 * TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour * TimeSpec.SecondsPerMinute * -1 );
		} // MonthsTest
		...
		public void DaysTest()
		{
			...
			Assert.Equal(0, dateDiff13.ElapsedYears);
			Assert.Equal(0, dateDiff13.ElapsedMonths);
			Assert.Equal<int>( dateDiff13.ElapsedDays, -1 );
			Assert.Equal(0, dateDiff13.ElapsedHours);
			Assert.Equal(0, dateDiff13.ElapsedMinutes);
			Assert.Equal(0, dateDiff13.ElapsedSeconds);
			...
			Assert.Equal<int>( dateDiff13.Days, -1 );
			Assert.Equal( dateDiff13.Hours, -TimeSpec.HoursPerDay );
			Assert.Equal<int>( dateDiff13.Minutes, TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour * -1 );
			Assert.Equal<int>( dateDiff13.Seconds, TimeSpec.HoursPerDay * TimeSpec.MinutesPerHour * TimeSpec.SecondsPerMinute * -1 );
		} // DaysTest
		...
		public void HoursTest()
		{
			...
			Assert.Equal(0, dateDiff13.ElapsedMonths);
			Assert.Equal(0, dateDiff13.ElapsedDays);
			Assert.Equal<int>( dateDiff13.ElapsedHours, -1 );
			Assert.Equal(0, dateDiff13.ElapsedMinutes);
			Assert.Equal(0, dateDiff13.ElapsedSeconds);
			...
			Assert.Equal<int>( dateDiff13.Hours, -1 );
			Assert.Equal<int>( dateDiff13.Minutes, TimeSpec.MinutesPerHour * -1 );
			Assert.Equal<int>( dateDiff13.Seconds, TimeSpec.MinutesPerHour * TimeSpec.SecondsPerMinute * -1 );
		} // HoursTest
		...
		public void MinutesTest()
		{
			...
			Assert.Equal(0, dateDiff13.ElapsedDays);
			Assert.Equal(0, dateDiff13.ElapsedHours);
			Assert.Equal<int>( dateDiff13.ElapsedMinutes, -1 );
			Assert.Equal(0, dateDiff13.ElapsedSeconds);
			...
			Assert.Equal<int>( dateDiff13.Minutes, -1 );
			Assert.Equal<int>( dateDiff13.Seconds, TimeSpec.SecondsPerMinute * -1 );
		} // MinutesTest
		...
		public void SecondsTest()
		{
			...
			Assert.Equal(0, dateDiff13.ElapsedHours);
			Assert.Equal(0, dateDiff13.ElapsedMinutes);
			Assert.Equal<int>( dateDiff13.ElapsedSeconds, -1 );
			...
			Assert.Equal<int>( dateDiff13.Seconds, -1 );
		} // SecondsTest
		...
		public void NegativeDurationTest()
		{
			...
			DateDiff dateDiff = new DateDiff( date1, date2 );
			Assert.Equal<int>( dateDiff.ElapsedYears, -1 );
			Assert.Equal<int>( dateDiff.ElapsedMonths, -1 );
			Assert.Equal<int>( dateDiff.ElapsedDays, -1 );
			Assert.Equal<int>( dateDiff.ElapsedHours, -1 );
			Assert.Equal<int>( dateDiff.ElapsedMinutes, -1 );
			Assert.Equal<int>( dateDiff.ElapsedSeconds, -1 );
