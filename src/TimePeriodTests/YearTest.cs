...
{	
	...
	public sealed class YearTest : TestUnitBase
	{
		...
		public void DefaultCalendarTest()
		{
			...
			Assert.Equal<int>( year.BaseYear, yearStart.Year );
			Assert.Equal<DateTime>( year.Start, yearStart.Add( year.Calendar.StartOffset ) );
			Assert.Equal<DateTime>( year.End, yearStart.AddYears( 1 ).Add( year.Calendar.EndOffset ) );
		} // DefaultCalendarTest
		...
		public void StartYearTest()
		{
			...
			Assert.Equal<int>( new Year( currentYear ).BaseYear, currentYear );
		...
		public void CurrentYearTest()
		{
			...
			Assert.Equal<int>( year.BaseYear, currentYear );
			Assert.Equal<DateTime>( year.Start, new DateTime( currentYear, 1, 1 ) );
		...
		public void YearIndexTest()
		{
			...
			Assert.True( year.IsReadOnly );
			Assert.Equal<int>( year.BaseYear, yearIndex );
			Assert.Equal<DateTime>( year.Start, new DateTime( yearIndex, 1, 1 ) );
		...
		public void YearPeriodTest()
		{
			...
			Assert.Equal(YearMonth.April, year.YearBaseMonth);
			Assert.Equal<int>( year.BaseYear, yearStart.Year );
			Assert.Equal<DateTime>( year.Start, yearStart );
			Assert.Equal<DateTime>( year.End, yearEnd );
		} // YearPeriodTest
		...
		public void YearCompareTest()
		{
			...
			Assert.Equal<int>( calendarYearSweden.BaseYear, calendarYearGermany.BaseYear + 1 );
			Assert.Equal<int>( calendarYearSweden.BaseYear, calendarYearUnitedStates.BaseYear + 1 );

			Assert.Equal<int>( calendarYearSweden.GetPreviousYear().BaseYear, calendarYearGermany.GetPreviousYear().BaseYear + 1 );
			Assert.Equal<int>( calendarYearSweden.GetPreviousYear().BaseYear, calendarYearUnitedStates.GetPreviousYear().BaseYear + 1 );

			Assert.Equal<int>( calendarYearSweden.GetNextYear().BaseYear, calendarYearGermany.GetNextYear().BaseYear + 1 );
			Assert.Equal<int>( calendarYearSweden.GetNextYear().BaseYear, calendarYearUnitedStates.GetNextYear().BaseYear + 1 );
		...
		public void GetPreviousYearTest()
		{
			...
			Assert.Equal<int>( previousYear.BaseYear, currentYearStart.Year - 1 );
			Assert.Equal<DateTime>( previousYear.Start, currentYearStart.AddYears( -1 ) );
			Assert.Equal<DateTime>( previousYear.End, currentYearStart );
		} // GetPreviousYearTest
		...
		public void GetNextYearTest()
		{
			...
			Assert.Equal<int>( nextYear.BaseYear, currentYearStart.Year + 1 );
			Assert.Equal<DateTime>( nextYear.Start, currentYearStart.AddYears( 1 ) );
			Assert.Equal<DateTime>( nextYear.End, currentYearStart.AddYears( 2 ) );
		} // GetNextYearTest
		...
		public void GetMonthsTest()
		{
			...
			foreach ( Month month in months )
			{
				...
				Assert.Equal<int>( month.Year, monthYear );
