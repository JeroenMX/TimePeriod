...
{	
	...
	public sealed class TimeTest : TestUnitBase
	{
		...
		public void EmptyConstructorTest()
		{
			...
			Assert.Equal<TimeSpan>( time.Duration, TimeSpan.Zero );
		...
		public void DateTimeConstructorTest()
		{
			...
			Assert.Equal<int>( time.Hour, test.Hour );
			Assert.Equal<int>( time.Minute, test.Minute );
			Assert.Equal<int>( time.Second, test.Second );
			Assert.Equal<int>( time.Millisecond, test.Millisecond );
		...
		public void DurationTest()
		{
			...
			Assert.Equal<int>( time.Hour, test.Hours );
			Assert.Equal<int>( time.Minute, test.Minutes );
			Assert.Equal<int>( time.Second, test.Seconds );
			Assert.Equal<int>( time.Millisecond, test.Milliseconds );

			Assert.Equal( time.Duration.Ticks, test.Ticks );

			Assert.Equal<double>( time.TotalHours, test.TotalHours );
			Assert.Equal<double>( time.TotalMinutes, test.TotalMinutes );
			Assert.Equal<double>( time.TotalSeconds, test.TotalSeconds );
			Assert.Equal<double>( time.TotalMilliseconds, test.TotalMilliseconds );
		} // DurationTest
		...
		public void ToDateTimeTest()
		{
			...
			Assert.Equal<DateTime>( time.ToDateTime( dateTime ), dateTime.Add( timeSpan ) );
		} // ToDateTimeTest
		...
		public void GetEmptyDateTimeTest()
		{
			...
			Assert.Equal<DateTime>( time.ToDateTime( dateTime ), dateTime );
